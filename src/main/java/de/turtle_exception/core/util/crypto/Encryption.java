package de.turtle_exception.core.util.crypto;
...
public class Encryption {
    ...
    private static @NotNull String doEncrypt(@NotNull String input, @NotNull SecretKey key, @NotNull IvParameterSpec iv) throws Exception {
    ...
    private static @NotNull String doDecrypt(@NotNull String cipherText, @NotNull SecretKey key, @NotNull IvParameterSpec iv) throws Exception {
        Cipher cipher = Cipher.getInstance(ALGORITHM);
    ...
    public static @NotNull String encrypt(@NotNull String input, @NotNull String pass) throws Exception {
        byte[] sa = generateSalt();

        IvParameterSpec ivParameterSpec = generateIv();
        SecretKey key = generateKeyFromPassword(pass, sa);

        String cipherText = doEncrypt(input, key, ivParameterSpec);
    ...
    public static @NotNull String decrypt(@NotNull String input, @NotNull String pass) throws Exception {
        ...
        return doDecrypt(cipherText, key, ivParameterSpec);
    }
}