...
public class SyncChannelDiscordChannelAddEvent extends SyncChannelEvent implements EntityUpdateEntryEvent<SyncChannel, DiscordChannel> {
    protected final DiscordChannel discordChannel;

    public SyncChannelDiscordChannelAddEvent(@NotNull SyncChannel channel, @NotNull DiscordChannel discordChannel) {
        super(channel);
