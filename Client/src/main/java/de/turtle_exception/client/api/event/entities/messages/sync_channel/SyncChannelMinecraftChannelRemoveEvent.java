...
public class SyncChannelMinecraftChannelRemoveEvent extends SyncChannelEvent implements EntityUpdateEntryEvent<SyncChannel, MinecraftChannel> {
    protected final MinecraftChannel minecraftChannel;

    public SyncChannelMinecraftChannelRemoveEvent(@NotNull SyncChannel channel, @NotNull MinecraftChannel minecraftChannel) {
        super(channel);
