...
public class ProjectUpdateTimeApplyEvent extends ProjectUpdateEvent<Long> {
    public ProjectUpdateTimeApplyEvent(@NotNull Project project, Long oldValue, Long newValue) {
