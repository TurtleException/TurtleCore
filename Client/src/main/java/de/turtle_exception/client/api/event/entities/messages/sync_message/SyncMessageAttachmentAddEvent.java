...
public class SyncMessageAttachmentAddEvent extends SyncMessageEvent implements EntityUpdateEntryEvent<SyncMessage, Long> {
    protected final long attachmentId;

    public SyncMessageAttachmentAddEvent(@NotNull SyncMessage message, long attachmentId) {
        super(message);
