...
public class ProjectMemberJoinEvent extends ProjectEvent implements EntityUpdateEntryEvent<Project, Long> {
    protected final long user;

    public ProjectMemberJoinEvent(@NotNull Project project, long user) {
        super(project);
        this.user = user;
    }
