...
public class ProjectMemberJoinEvent extends ProjectEvent implements EntityUpdateEntryEvent<Project, User> {
    protected final User user;

    public ProjectMemberJoinEvent(@NotNull Project project, @NotNull User user) {
        super(project);
        this.user = user;
    }
