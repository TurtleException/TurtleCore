...
class Statements {
    ...
    public static final String CT_GROUPS         = "CREATE TABLE IF NOT EXISTS `groups` (`id` BIGINT NOT NULL , `name` TINYTEXT NOT NULL , `permissions` BIGINT NOT NULL , `permissions_discord` BIGINT NOT NULL , PRIMARY KEY (`id`));";
    ...
    public static final String CT_USERS          = "CREATE TABLE IF NOT EXISTS `users` (`id` BIGINT NOT NULL , `name` TINYTEXT NOT NULL , `permissions` BIGINT NOT NULL , `permissions_discord` BIGINT NOT NULL , PRIMARY KEY (`id`));";
    ...
    public static final String SET_GROUP     = "INSERT INTO `groups` (`id`, `name`, `permissions`, `permissions_discord`) VALUES ('{0}', '{1}', '{2}', '{3}') ON DUPLICATE KEY UPDATE `name` = '{1}';";
    ...
    public static final String SET_USER     = "INSERT INTO `users` (`id`, `name`, `permissions`, `permissions_discord`) VALUES ('{0}', '{1}', '{2}', '{3}') ON DUPLICATE KEY UPDATE `name` = '{1}';";
